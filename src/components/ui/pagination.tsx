...
const PaginationPrevious = ({
  ...
  <PaginationButton
    ...
    {...props}
  >
    <ChevronLeft className="h-4 w-4 text-secondaryText" />
...
const PaginationNext = ({
  ...
  >
    ...
    <ChevronRight className="h-4 w-4 text-secondaryText" />
  </PaginationButton>
);
...
const PaginationNextLink = ({
  ...
  <PaginationLink
    ...
    {...props}
  >
    <span className="hidden sm:inline text-white text-sm ">Next</span>
